...
def data_read() -> dict:
    """This data wrangling script is used to read data for Python. \
        The raw data is provided as a csv-file in a subfolder 'data'. \ # TODO: ...is downloaded...
        Here we preprocess a data set for further use. \
        
        Data description: \
            Annual average atmospheric carbon dioxide (CO2) contents expressed as \
            a mole fraction in dry air, micromol/mol, commonly abbreviated as ppm. For \
            example 413 ppm means that in every million molecules of (dry) air \
            there are on average 413 molecules of CO2.
        ...
        Data source: \
            ...
            Mauna Loa CO2 annual mean data (CSV) ftp://aftp.cmdl.noaa.gov/products/trends/co2/co2_annmean_mlo.csv downloaded on 2020-10-27.
